        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="tab-content">
              ...
              <!-- Світло — просто статична карта нормалей -->
              <div class="tab-pane fade" id="tab-light">
                ${currentItem.normalMap ? 
                  ...
                  '<p class="text-muted text-center mt-5">Карта нормалей відсутня</p>'
                }
              </div>
              <!-- Об’єм -->
              <div class="tab-pane fade" id="tab-volume">
                ${currentItem.model ? 
                  ...
                  '<p class="text-muted text-center mt-5">3D-модель відсутня</p>'
                }
              </div>
            </div>
          </div>
